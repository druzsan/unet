...
def unet(weights=None, input_shape=(256, 256, 1), classes=1, background_as_class=False, batch_normalization=False):
    ...
    conv4 = double_conv2d(pool3, 512, 3, padding='same', batch_normalization=batch_normalization, dropout_rate=.5)
    # conv4 = layers.Dropout(0.5)(conv4)
    pool4 = layers.MaxPooling2D(pool_size=(2, 2))(conv4)

    conv5 = double_conv2d(pool4, 1024, 3, padding='same', batch_normalization=batch_normalization, dropout_rate=.5)
